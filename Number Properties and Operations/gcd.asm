section .data
    ...
    dispMsg     db  'Greatest common factor of the inputs is: '
...
_start:
    ...
    call    writeNum
    call    newLine
    mov     rdx,rax ;as you can see in gcd, the gcd (gcc) is stored in rax. here we move that to rdx only to satisfy the question's conditions
