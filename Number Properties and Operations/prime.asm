section .data
    ...
    isPrimeMsg   db  'The entered number is prime!'
    lenIsPrimeMsg    equ     $-isPrimeMsg
    notPrimeMsg   db  'The entered number is not prime.'
    lenNotPrimeMsg    equ     $-notPrimeMsg
